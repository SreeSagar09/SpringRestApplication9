...
public class ApplicationController {	
	...
	public ResponseEntity<String> handlerMethod1(@RequestParam String param){
		ResponseEntity<String> responseEntity = new ResponseEntity<String>(param, HttpStatus.OK);
	...
	public ResponseEntity<String[]> handlerMethod2(@RequestParam(name = "param") String[] values){
		ResponseEntity<String[]>  responseEntity = new ResponseEntity<String[]>(values, HttpStatus.OK);
	...
	public ResponseEntity<Map<String, String>> handlerMethod3(@RequestParam Map<String, String> params){
		ResponseEntity<Map<String, String>>  responseEntity = new ResponseEntity<Map<String, String>>(params, HttpStatus.OK);
	...
	public ResponseEntity<MultiValueMap<String, Object>> handlerMethod4(@RequestParam MultiValueMap<String, Object> params){
		ResponseEntity<MultiValueMap<String, Object>>  responseEntity = new ResponseEntity<MultiValueMap<String, Object>>(params, HttpStatus.OK);
	...
	public ResponseEntity<List<String>> handlerMethod5(@RequestParam(value = "param") List<String> params){
		ResponseEntity<List<String>>  responseEntity = new ResponseEntity<List<String>>(params, HttpStatus.OK);
